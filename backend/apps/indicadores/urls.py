...
urlpatterns = [
    ...
    path('rh/movimentacao/exportar/', RHMovimentacaoExportView.as_view(), name='indicador-rh-movimentacao-exportar'),
    ...
    path('frota/custos/', FrotaCustosIndicadorView.as_view(), name='indicador-frota-custos'),
