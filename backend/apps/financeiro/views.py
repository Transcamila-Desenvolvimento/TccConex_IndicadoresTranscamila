...
class MetaFaturamentoConfigView(ModuleScopedViewMixin, APIView):
    ...
    def get(self, request):
        from .meta_faturamento_config import _parse_ano, build_metas_ano_payload
    ...
    def put(self, request):
        from .meta_faturamento_config import _parse_ano, save_metas_ano
        ...
        record_audit(
            request.user,
            'financeiro.meta_faturamento.atualizado',
